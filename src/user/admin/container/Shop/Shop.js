                                                ...
                                                <ul className="list-unstyled fruite-categorie">
                                                    <li>
                                                        <div className="d-flex justify-content-between fruite-name">
                                                            ...
                                                            <span>({fruits.filter(fruit => fruit.name === "Apple").length})</span>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div className="d-flex justify-content-between fruite-name">
                                                            <a href="#"><i className="fas fa-apple-alt me-2" />Oranges</a>
                                                            <span>({fruits.filter(fruit => fruit.name === "Orange").length})</span>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div className="d-flex justify-content-between fruite-name">
                                                            <a href="#"><i className="fas fa-apple-alt me-2" />Strawbery</a>
                                                            <span>({fruits.filter(fruit => fruit.name === "Strawberry").length})</span>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div className="d-flex justify-content-between fruite-name">
                                                            <a href="#"><i className="fas fa-apple-alt me-2" />Banana</a>
                                                            <span>({fruits.filter(fruit => fruit.name === 'Banana').length})</span>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div className="d-flex justify-content-between fruite-name">
                                                            <a href="#"><i className="fas fa-apple-alt me-2" />Grapes</a>
                                                            <span>({fruits.filter(fruit => fruit.name === 'Grapes').length})</span>
                                                        </div>
                                                    </li>
                                                </ul> */}
                                            </div>
